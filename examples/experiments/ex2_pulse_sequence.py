...
class PulseSequence(JaxExperiment, SinaraEnvironment):
    ...
    def get_mock_drift_trackers(self):
        ...
        self.add_attribute("468", pickle.dumps(param_468, protocol=4), "drift_trackers")
        param_1079 = {"center_frequency": 105*MHz, "detuning_factor": -2, "center_drift_rate": 0.,
                      "last_calibration": 0., "Zeeman": None}
        self.drift_trackers["1079"] = DriftTracker(param_1079, protocol=4)
        self.add_attribute("1079", pickle.dumps(param_1079), "drift_trackers")
